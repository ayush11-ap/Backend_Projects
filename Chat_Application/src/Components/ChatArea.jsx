...
const ChatArea = ({ props }) => {
  return (
    <div className="lg:flex-[0.7] lg:flex lg:flex-col">
      ...
      <div className="msg-container lg:flex-1 lg:bg-white lg:px-3 lg:py-3 lg:m-3 lg:rounded-xl lg:overflow-y-auto">
        <MessageOthers />
        <MessageSelf />
        <MessageOthers />
        <MessageSelf />
      ...
      <div className="inp-area lg: lg:bg-white lg:px-3 lg:py-3 lg:m-3 lg:rounded-xl lg:flex lg:justify-center">
        <input
          type="text"
          placeholder="Search"
