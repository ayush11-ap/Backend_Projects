...
const ConversationData = ({ props }) => {
  return (
    <div className="conversation-container lg:grid lg:grid-cols-[32px_auto_auto] lg:grid-rows-[auto_auto] lg:gap-x-2.5 lg:p-1.25 lg:my-4 lg:mx-3 lg:rounded-[20px]">
