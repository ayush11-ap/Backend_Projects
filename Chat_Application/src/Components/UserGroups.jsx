...
const UserGroups = () => {
  return (
    <div className="list-cont lg:flex-[0.7] lg:flex lg:flex-col">
      ...
      >
        <div className="list-item lg:flex lg:items-center lg:bg-white lg:rounded-full lg:px-3 lg:py-2 lg:m-3 lg:transition-all lg:shadow-[-4px_4px_5px_0px_rgba(0,_0,_0,_0.1)] lg:select-none">
